...
// happens to fit cannot pass for it. On the strategy page it also counts the fields in the first
// row of the Data and sizing grid and fails under six (UI-04: numeric fields take one auto-fit
// track, dates and selects two).
//
