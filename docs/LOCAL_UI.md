...
- A Studies page: pick lake instruments, features, sampling grid, horizons, and decision delay; the API runs the study and the page shows the IC heat table (feature by horizon, with top-minus-bottom decile bps and t-stat on hover) and a decile table per feature and horizon.
